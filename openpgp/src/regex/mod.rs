...
//!         alice_userid)?;
//! let alice = alice.insert_packets2(alice_certification.clone())?.0;
...
//!         bob_userid)?;
//! let bob = bob.insert_packets2(bob_certification.clone())?.0;
...
//!         ca_userid)?;
//! let ca = ca.insert_packets2(ca_tsig.clone())?.0;
